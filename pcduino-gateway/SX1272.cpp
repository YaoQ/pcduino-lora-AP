...
*/
unsigned char SX1272::readRegister(unsigned char address)
{
#if 0
    digitalWrite(SX1272_SS,LOW);
...
#endif
#endif
    spi_bash  *spix = new spi_bash();
    spix->read_buf_spi(address,1,(unsigned char*)rxbuf);
   delete(spix);
...
*/
void SX1272::writeRegister(unsigned char address, unsigned char data)
{
#if 0
    digitalWrite(SX1272_SS,LOW);
    delay(1);
...
#endif
    spi_bash  *spix = new spi_bash();
    spix->write_buf_spi(address, 1, &data);
    delete(spix);
